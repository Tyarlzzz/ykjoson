<?php
    ...
    class Expense extends Model {
        ...
        public static function getByMonthYear($month, $year, $business_type = 'Laundry Business') {
            try {
        ...
        public static function getMonthlyTotal($month, $year, $business_type = 'Laundry Business') {
            try {
