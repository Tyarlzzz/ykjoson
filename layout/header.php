        ...
        <aside id="sidebar" class="w-[260px] h-screen flex flex-col shadow-2xl transition-all duration-600 overflow-hidden flex-shrink-0">
            ...
            <nav class="flex-1 flex flex-col px-4 font-['Switzer']">
                ...
                <ul class="space-y-10">
                    ...
                    <li>
                        <a href="../Gas/OrderList.php" class="nav-item flex items-center gap-3 ml-6">
                            <svg class="w-6 h-6 text-white flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="../Gas/updateInventory.php" class="nav-item flex items-center gap-3 ml-6">
                ...
                <div class="mt-auto mb-20">
                    <!-- if else pang swap ng dashboard -->
