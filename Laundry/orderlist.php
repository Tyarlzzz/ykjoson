...
<main class="flex-1 overflow-x-hidden overflow-y-hidden h-screen flex flex-col">
    <div class="justify-between flex">
        <h1 class="font-['Outfit'] font-bold text-4xl py-3 pl-3 mt-5">&nbsp;&nbsp;|&nbsp;&nbsp;Order List</h1>
        <a href="create.php">
            <div class="bg-gradient-to-br from-blue-600 via-blue-500 to-purple-300 to-purple-500 to-purple-400 rounded-2xl shadow-xl mt-5 me-6">
                <div class="flex justify-between items-center gap-3 p-3">
                    <svg class="w-10 h-10 mt-2 flex-shrink-0" fill="currentColor" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="-5.0 -10.0 110.0 135.0">
        ...
        <table id="orderlistTable" class="w-full">
            ...
            <tbody>
                <?php if ($Laundry && count($Laundry) > 0): ?>
                    ...
                    <tr>
                        <td class="<?php echo $order['is_rushed'] ? 'font-bold text-red-600' : '' ?>"><?php echo $counter++; ?></td> <!-- dito diba mag kulay red ang id kapag rushed order. Ang naisip ko is if customer.rushed == true, mag red ang id -->
