...
try {
    ...
    // Fetch order items - FIXED: Removed the JOIN to product_code table
    $itemsSql = "SELECT loi.product_code_id, loi.quantity
    ...
    foreach ($orderItems as $item) {
        $code_id = $item['product_code_id'];
        if (isset($itemMapping[$code_id])) {
            $quantities[$itemMapping[$code_id]] = $item['quantity'];
        }
    }
...
<main class="font-[Switzer] flex-1 p-8 bg-gray-50 overflow-auto">
  <div class="w-full px-1">
    ...
    <form action="update.php" method="POST" id="orderForm">
      ...
      <div class="flex gap-8">
          ...
          <div class="mb-6">
            <div class="grid grid-cols-6">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <input type="text" id="phone_number" name="phone_number" placeholder="Enter phone number"
                      value="<?php echo htmlspecialchars($order['phone_number']); ?>"
                      class="w-full px-4 py-3 border-2 border-gray-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-50 focus:border-blue-500 text-gray-800 font-medium">
                  </div>
                </div>
              ...
              <div class="ms-4 mb-4 mt-7 col-span-1 flex items-stretch items-center">
                <button id="is_rushed" type="button" 
                  class="w-full <?php echo $order['is_rushed'] ? 'bg-red-600 hover:bg-red-600' : 'bg-gray-500 hover:bg-gray-600'; ?> text-white px-2 py-2 rounded-xl sm:text-xs md:text-md lg:text-xl text-center font-bold transition-colors duration-200">
                  Rush Order
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <textarea id="note" name="note" rows="3" placeholder="Add any special notes..."
                class="w-full px-4 py-3 border-2 border-gray-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-50 focus:border-blue-500 resize-none text-gray-800 font-medium"><?php echo htmlspecialchars($order['note']); ?></textarea>
            </div>
          </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="tops-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      ...
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('tops')"><?php echo $quantities['tops']; ?></span>
                  </div>
                  <button type="button" onclick="decreaseQty('tops')"
                    class="w-10 h-10 sm:w-12 sm:h-12 md:w-12 md:h-12 lg:w-8 lg:h-8 bg-red-600 hover:bg-red-600 text-white rounded-full flex items-center justify-center font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl aspect-square p-0">−</button>
                  <button type="button" onclick="increaseQty('tops')"
                    class="w-10 h-10 sm:w-12 sm:h-12 md:w-12 md:h-12 lg:w-8 lg:h-8 bg-green-600 hover:bg-green-600 text-white rounded-full flex items-center justify-center font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl aspect-square p-0">+</button>
                </div>
              </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="bottoms-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('bottoms')"><?php echo $quantities['bottoms']; ?></span>
                  </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="undies-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('undies')"><?php echo $quantities['undies']; ?></span>
                  </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="socks-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('socks')"><?php echo $quantities['socks']; ?></span>
                  </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="towels-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('towels')"><?php echo $quantities['towels']; ?></span>
                  </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="beds-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('beds')"><?php echo $quantities['beds']; ?></span>
                  </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="gowns-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('gowns')"><?php echo $quantities['gowns']; ?></span>
                  </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="barong-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('barong')"><?php echo $quantities['barong']; ?></span>
                  </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="curtains-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('curtains')"><?php echo $quantities['curtains']; ?></span>
                  </div>
                ...
                <div class="flex items-center justify-center gap-1">
                  <div class="inline-flex overflow-hidden border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                    <span id="comforter-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-xl focus:outline-none"
                      onfocus="this.classList.add('bg-gray-100')"
                      onblur="this.classList.remove('bg-gray-100'); handleQtyChange('comforter')"><?php echo $quantities['comforter']; ?></span>
                  </div>
        ...
        <div class="w-1/3">
          <div class="sticky top-8">
            <div class="bg-white rounded-2xl shadow-xl p-6">
              ...
              <div class="space-y-3 mb-4 text-sm overflow-y-auto max-h-96">
                <div class="flex justify-between items-start">
                  ...
                  <div class="flex-1 min-w-0 ml-2 break-words text-right">
                    <span id="summary-name" class="font-semibold text-gray-800 block"><?php echo htmlspecialchars($order['fullname']);?>
                    </span>
                  </div>
                </div>
                <div class="flex justify-between items-start">
                  ...
                  <div class="flex-1 min-w-0 ml-2 break-words text-right">
                    <span id="summary-phone" class="font-semibold text-gray-800 block"><?php echo htmlspecialchars($order['phone_number']);?>
                    </span>
                  </div>
                </div>
                <div class="flex justify-between items-start">
                  ...
                  <div class="flex-1 min-w-0 ml-2 break-words text-right">
                    <span id="summary-address" class="font-semibold text-gray-800 block"><?php echo htmlspecialchars($order['address']);?>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="border-t border-black pt-4 mb-4">
                <div class="flex items-center space-x-3 mb-4 text-sm">
                  <input type="checkbox"
                    ...
                    <?php echo $order['is_rushed'] ? 'checked' : ''; ?>>
              ...
              <div class="border-t pt-4">
                ...
                <div class="text-sm text-gray-600">
                  ...
                  <p id="summary-notes" class="mt-1 text-gray-500 break-words max-w-full"></p><?php echo htmlspecialchars($order['note']);?>
                </div>
              </div>
            </div>
            ...
            <!-- Delete Order Button -->
            <button type="button" onclick="deleteOrder(<?php echo $order_id; ?>)"
              class="w-full mt-3 bg-red-600 hover:bg-red-700 text-white py-3 rounded-lg font-semibold transition">
              Delete Order
            </button>
          </div>
        </div>
      ...
      <input type="hidden" id="tops-qty-input" name="topsQty" value="<?php echo $quantities['tops']; ?>">
      <input type="hidden" id="bottoms-qty-input" name="bottomsQty" value="<?php echo $quantities['bottoms']; ?>">
      <input type="hidden" id="undies-qty-input" name="undiesQty" value="<?php echo $quantities['undies']; ?>">
      <input type="hidden" id="socks-qty-input" name="socksQty" value="<?php echo $quantities['socks']; ?>">
      <input type="hidden" id="towels-qty-input" name="towelsQty" value="<?php echo $quantities['towels']; ?>">
      <input type="hidden" id="beds-qty-input" name="bedsQty" value="<?php echo $quantities['beds']; ?>">
      <input type="hidden" id="gowns-qty-input" name="gownsQty" value="<?php echo $quantities['gowns']; ?>">
      <input type="hidden" id="barong-qty-input" name="barongQty" value="<?php echo $quantities['barong']; ?>">
      <input type="hidden" id="curtains-qty-input" name="curtainsQty" value="<?php echo $quantities['curtains']; ?>">
      <input type="hidden" id="comforter-qty-input" name="comforterQty" value="<?php echo $quantities['comforter']; ?>">
    </form>
  </div>
</main>
