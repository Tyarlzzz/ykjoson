...
<main class="font-[Switzer] flex-1 p-8 bg-gray-50 overflow-auto">
    <div class="w-full">
        ...
        <div class="flex mb-0">
            <a href="expenses.php"
            class="px-8 py-1 bg-blue-600 text-white font-semibold rounded-t-2xl z-0">Expenses</a>
            <a href="salesReport.php" class="px-5 py-1 bg-gray-300 text-gray-700 font-semibold rounded-t-2xl -ml-3 z-0">Sales
            Report</a>
            <a href="pricing.php"
        ...
        <div class="w-full bg-white rounded-lg rounded-tl-none shadow-md border border-gray-200 overflow-hidden">
            ...
            <div class="flex justify-between items-center pb-4">
                <h2 class="text-3xl font-[Outfit] space-x-2">Weekly Expenses Report&nbsp;&nbsp;<span class="font-[Switzer] text-lg"><?php echo date("F, Y");?></span></h2>
                <button id="createWeekBtn" class="px-4 py-2 bg-blue-600 text-white font-semibold rounded-xl font-['Switzer'] flex items-center gap-2 hover:bg-blue-700 transition-colors">
                        ...
                        <div class="productList space-y-3 mb-6">
                            <div class="flex justify-between items-center product-row gap-4 mx-4">
                                <div class="flex items-center gap-3 flex-1">
                                    ...
                                    <input type="text" placeholder="Enter product" value="" class="flex-1 text-lg bg-white border-2 border-gray-300 focus:border-blue-600 focus:outline-none px-4 py-2 rounded-lg transition-colors product-input">
                                </div>
                                <input type="number" placeholder="0.00" value="" class="w-24 text-lg bg-white border-2 border-gray-300 focus:border-blue-600 focus:outline-none px-4 py-2 rounded-lg text-right transition-colors price-input">
                            </div>
                        </div>

                        <div class="flex justify-end me-4 mb-3">
                            <button id="addProductBtn" class="bg-green-500 text-white w-12 h-12 rounded-full text-3xl font-semibold flex items-center justify-center hover:bg-green-600 transition-colors">
                                +
                            </button>
                        </div>

                        <div class="flex justify-end me-4 gap-3">
                            <button id="cancelBtn" class="px-6 py-2 bg-gray-600 text-white font-semibold rounded-xl hover:bg-gray-700 transition-colors hidden">
                                Cancel
                            </button>
                            <button id="saveExpensesBtn" class="px-6 py-2 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors">
                                Save Expenses
                            </button>
                        </div>
                    </div>
