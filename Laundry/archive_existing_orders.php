<?php
/**
 * Utility script to manually archive existing paid laundry orders
...
try {
    // Get all paid laundry orders from 2+ days ago that haven't been archived yet
    ...
    foreach ($paidOrders as $order) {
        ...
        try {
            if (LaundryArchivedOrder::archiveOrderWithCustomDeliveryDate($order_id)) {
                $archived_count++;
