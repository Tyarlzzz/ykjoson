...
<main class="font-[Switzer] flex-1 p-8 bg-gray-50 overflow-auto">
    <div class="w-full">
        <div class="mb-6 flex justify-between items-center">
            <h1 class="ps-3 font-['Outfit'] text-3xl font-extrabold border-l-4 border-gray-900 text-gray-800">Inventory & Sales Report</h1>
        ...
        <div class="flex mb-0">
            ...
            <a href="salesReport.php" class="px-5 py-1 bg-gray-300 text-gray-700 font-semibold border-l-2 border-gray-400 rounded-t-2xl -ml-3 z-0">Sales Report</a>
            <a href="pricing.php" class="px-8 py-1 bg-blue-600 text-white border-l-2 border-gray-400 rounded-t-2xl -ml-3 z-0">Pricing</a>
