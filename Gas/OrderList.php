            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <a href="index.php" class="duration-100">
                        <svg class="w-6 h-6 rotate-180" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 64 80" fill="none" x="0px" y="0px">
                ...
                <?php if ($gasOrders && count($gasOrders) > 0): ?>
                    ...
                    <?php foreach ($gasOrders as $order): ?>
                        <tr>
                            ...
                            <td class="<?php echo $order['is_rushed'] ? 'text-red-600 font-bold' : ''; ?>">
                                <?php echo $counter++; ?>
                            </td>
                            <td>
