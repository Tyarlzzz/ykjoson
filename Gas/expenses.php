...
<main class="font-[Switzer] flex-1 p-8 bg-gray-50 overflow-auto">
  <div class="w-full">
    ...
    <!-- Navigation Tabs -->
    <div class="flex mb-0">
      <a href="expenses.php" class="px-8 py-1 bg-red-600 text-white font-base rounded-t-2xl">Expenses</a>
...
<div class="w-full bg-white rounded-lg rounded-tl-none shadow-md border border-gray-200 overflow-hidden">
  <div class="p-6">
    ...
    <div id="monthlyTotalCard" 
         class="bg-red-100 border border-red-300 rounded-xl p-5 mb-6 flex justify-between items-center">
      <h3 class="text-3xl font-[Outfit] text-gray-700">Total Monthly Expenses</h3>
      <span id="monthlyTotalValue" class="text-3xl font-bold text-red-700">₱ 0.00</span>
    </div>

    <div class="flex justify-between items-center pb-4">
      <h2 class="text-3xl font-[Outfit] space-x-2">
        Weekly Expenses Report&nbsp;&nbsp;
        <span class="font-[Switzer] text-lg"><?php echo date("F, Y"); ?></span>
      </h2>
      <button id="createWeekBtn"
        class="px-4 py-2 bg-red-600 text-white font-semibold rounded-xl font-['Switzer'] flex items-center gap-2 hover:bg-red-700 transition-colors">
      ...
      <div class="bg-[#e7e6e6] rounded-xl shadow-lg p-6">
        ...
        <div class="productList space-y-3 mb-6">
          <div class="flex justify-between items-center product-row gap-4 mx-4">
            <div class="flex items-center gap-3 flex-1">
              ...
              <select
                class="flex-1 text-lg bg-white border-2 border-gray-300 focus:border-red-600 focus:outline-none px-4 py-2 rounded-lg transition-colors product-input">
                <option value="">Select product</option>
                <option value="petron">Petron</option>
                <option value="econo">Econo</option>
                <option value="seagas">Seagas</option>
              </select>
            </div>
            <input type="number" placeholder="0.00" value=""
              class="w-24 text-lg bg-white border-2 border-gray-300 focus:border-red-600 focus:outline-none px-4 py-2 rounded-lg text-right transition-colors price-input">
          </div>
        </div>
        ...
        <div class="flex justify-end me-4 gap-3">
          ...
          <button id="saveExpensesBtn"
            class="px-6 py-2 bg-red-600 text-white font-semibold rounded-xl hover:bg-red-700 transition-colors">
            Save Expenses
          </button>
        </div>
      </div>
...
<script src="../assets/js/gas_system_js/gasExpenses.js"></script>
