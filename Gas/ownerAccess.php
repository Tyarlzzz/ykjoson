  ...
  <div class="w-full max-w-md p-8 bg-white rounded-xl shadow-lg">
    ...
    <form method="POST" autocomplete="off">
      <div class="space-y-3">
        ...
        <div class="relative">
          <input type="password" id="password" name="password"
            class="w-full px-4 py-2 ms-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none"
      ...
      <div class="flex justify-end mt-6">
        <button type="submit" class="bg-red-500 text-white font-semibold py-2 px-6 rounded-lg">
          Confirm
        </button>
      </div>
