        ...
        <div class="mb-6">
          ...
          <div class="grid grid-cols-4">
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto p-0 my-4 border-2 border-gray-200 bg-white shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('petron')">
              ...
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="petron-qty" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none">0</span>
                </div>
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto p-0 my-4 border-2 border-gray-200 bg-white shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('econo')">
                <img src="../assets/images/econo.png" alt="Econo" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="econo-qty" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none">0</span>
                </div>
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto my-4 p-0 border-2 border-gray-200 bg-white shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('seagas')">
                <img src="../assets/images/seagas.png" alt="SeaGas" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="seagas-qty" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none">0</span>
                </div>
