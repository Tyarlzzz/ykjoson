      ...
      <div class="flex-1">
        ...
        <div class="mb-6">
          ...
          <div class="grid grid-cols-6">
            ...
            <div class=" ms-4 mb-4 mt-7 col-span-1 flex items-stretch">
              <button id="rushButton" type="button" class="w-full bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-xl text-xl font-bold transition-colors duration-200">
                Rush Order
              </button>
            </div>
          </div>
        ...
        <div class="mb-6">
          ...
          <div class="grid grid-cols-4">
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto p-0 my-4 border-2 border-gray-200 bg-white shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('tops')">
                <img src="../assets/images/tops.png" alt="Tops" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="tops-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto my-4 p-0 bg-white border-2 border-gray-200 shadow-sm rounded-2xl flex items-center justify-center"  onclick="increaseQty('bottoms')">
                <img src="../assets/images/bottoms.png" alt="Bottoms" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-2">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="bottoms-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto p-0 my-4 bg-white border-2 border-gray-200 shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('undies')">
                <img src="../assets/images/undies.png" alt="Undies" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="undies-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
            ...
            <!-- Socks -->
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              <h3 class="font-bold text-gray-700 text-lg">Socks (by pair)</h3>
              <div
                class="w-44 h-44 mx-auto my-4 p-0 bg-white border-2 border-gray-200 shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('socks')">
                <img src="../assets/images/socks.png" alt="Socks" class="w-32 h-32 object-contain">
              </div>


              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="socks-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
        ...
        <div class="mt-6 mb-6">
          ...
          <div class="grid grid-cols-4">
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto p-0 my-4 border-2 border-gray-200 bg-white shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('towels')">
                <img src="../assets/images/towels.png" alt="Towels" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="towels-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto my-4 p-0 bg-white border-2 border-gray-200 shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('beds')">
                <img src="../assets/images/beds.png" alt="Beds" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-2">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="beds-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto p-0 my-4 bg-white border-2 border-gray-200 shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('gowns')">
                <img src="../assets/images/gowns.png" alt="Gowns" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="gowns-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto my-4 p-0 bg-white border-2 border-gray-200 shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('barong')">
                <img src="../assets/images/barong.png" alt="Barong" class="w-32 h-32 object-contain">
              </div>


              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="barong-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
        ...
        <!-- SECOND ROW -->
          <div class="mt-10 grid grid-cols-4">
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto p-0 my-4 border-2 border-gray-200 bg-white shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('curtains')">
                <img src="../assets/images/curtains.png" alt="Tops" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="curtains-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
            ...
            <div class="item-card bg-gray-50 text-center border-2 border-transparent hover:border-blue-300">
              ...
              <div
                class="w-44 h-44 mx-auto p-0 my-4 border-2 border-gray-200 bg-white shadow-sm rounded-2xl flex items-center justify-center" onclick="increaseQty('comforter')">
                <img src="../assets/images/comforter.png" alt="Comforter" class="w-32 h-32 object-contain">
              </div>
              <div class="flex items-center justify-center gap-3">
                <div class="inline-flex border-2 border-gray-200 shadow-sm items-center justify-center bg-white rounded-md px-2 py-1">
                  <span id="comforter-qty" contenteditable="true" class="w-12 text-center font-bold text-gray-700 text-2xl focus:outline-none"
                  onfocus="this.classList.add('bg-gray-100')" 
